        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mb-4">
              ...
              <h2 className="text-[#00df9a]">{post.id}. {post.name}</h2>
              <h2 className="mb-2 text-gray-500 font-bold">{post.company.name}</h2>
              <h3>{post.email}</h3>
            </div>

            <div>
              <h1 className="text-3xl text-center p-4 mb-4">Posts</h1>
              {comments.length > 0 && (
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                  {comments.map((comment) => (
                    ...
                    >
                      <h1 className="mb-2 font-bold">Post Id : {comment.id}</h1>
                      <h2 className="text-[#00df9a]">Email: {comment.title}</h2>
